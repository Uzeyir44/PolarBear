...
__all__ = ["auth_router", "avatar_router", "clothing_router", "competition_requests_router", "competitions_router", "votes_router", "qr_router", "users_router", "wardrobe_router", "admin_router"]
